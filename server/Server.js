...
export default class Server {
  constructor(port) {
    ...
    this._app.use(
      "/avatars",
      express.static("../public/avatars", staticOptions)
    );
    this._app.use("/sw.js", (req, res) =>
      res.sendFile(path.resolve("../public/sw.js"), staticOptions)
    );
    this._app.use("/sw.js.map", (req, res) =>
      res.sendFile(path.resolve("../public/sw.js.map"), staticOptions)
    );
    this._app.use("/manifest.json", (req, res) =>
      res.sendFile(path.resolve("../public/manifest.json"), staticOptions)
    );
